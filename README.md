...
- peg insertion success prediction
- evaluation on controllable noisy ablations

There is also additional support for other formats, including VQA for LLM fine-tuning.
